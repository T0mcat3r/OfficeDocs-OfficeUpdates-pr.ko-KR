...
이러한 릴리스 정보는 2018년 Office 365 ProPlus의 반기 채널 업데이트에 포함된 새로운 기능, 보안 업데이트 및 비보안 업데이트에 대한 정보를 제공합니다. 

> [!NOTE]
> - 또한 Visio Pro for Office 365 및 Project Online 데스크톱 클라이언트에 대한 새로운 기능, 보안 업데이트 및 비보안 업데이트에 대한 정보도 제공합니다.
> - 이 정보는 Business Premium 과 같은 일부 Office 365 계획에 제공되는 Office 버전인 Office 365 Business에도 적용됩니다.
> - 2018년 1월 이전에는 반기 채널을 지연 채널이라고 했습니다.
...
*2018년 1월부터 제공된 반기 채널 릴리스입니다. 이 릴리스는 2019년 3월까지 계속 지원되며 보안 업데이트를 받게 됩니다. 그러나 이제 새로운 반기 채널 릴리스 버전 1803(빌드 16.0.9126.2282)을 사용할 수 있습니다. 여기에는 새로운 기능, 보안 업데이트 및 비보안 업데이트가 포함되어 있습니다.*
...
## <a name="version-1708-august-14"></a>버전 1708: 년 8 월 14
*버전 1708 (빌드 8431.2299)*

*2018년 1월부터 제공된 반기 채널 릴리스입니다. 이 릴리스는 2019년 3월까지 계속 지원되며 보안 업데이트를 받게 됩니다. 그러나 이제 새로운 반기 채널 릴리스 버전 1803(빌드 16.0.9126.2275)을 사용할 수 있습니다. 여기에는 새로운 기능, 보안 업데이트 및 비보안 업데이트가 포함되어 있습니다.*
...
-   **3D 모델:** 3D를 사용하여 통합 문서의 시각적 효과 및 창의적 효과를 향상 시킬 수 있습니다.  3D 모델을 간편하게 삽입한 후 360도로 회전 시킬 수 있습니다. [자세한 정보](https://support.office.com/article/ec5feb79-b0af-47f6-a885-151fcc88ac0a)
-   **새 잉크 효과:** 금속 펜과 무지개, 은하수, 용암, 바다, 금색, 은색 등의 잉크 효과를 사용하여 세련된 아이디어를 표현할 수 있습니다.
-   **파일 공유 UI:** 비즈니스용 OneDrive 또는 SharePoint 파일의 경우, 리본의 오른쪽 상단 모서리에 있는 공유 단추를 클릭하거나 파일 \> 공유로 이동하면 간단하게 개선된 공유 대화 상자가 나타납니다. UI는 사용자가 새 파일 또는 로컬에 저장된 파일을 쉽게 OneDrive에 업로드하여 공동 작업을 시작할 수 있게 합니다.
-   **위험한 확장명 차단:** 높은 위험을 초래할 것으로 보이며, OLE 패키지 개체로 내장된 확장명은 기본적으로 활성화되지 않도록 차단됩니다. 예로 .exe, .vbs 및 .js가 있습니다. [자세한 정보](https://support.office.com/article/packager-activation-in-office-365-desktop-applications-52808039-4a7c-4550-be3a-869dd338d834)
...
-   **계정별 파일 위치:** 파일을 열거나 저장할 때 위치 목록이 위치에 연결된 계정을 기준으로 구성됩니다.
...
-   SharePoint Online에서 파일을 열면 Excel 작업이 중단되는 문제를 해결합니다.
...
-   인쇄 또는 인쇄 미리 보기에서 워크시트의 슬라이서에서 콘텐츠가 잘린 상태로 워크시트 일부만 인쇄되거나 표시되는 문제를 해결합니다.
-   보호된 통합 문서에서 텍스트 파일로 새로운 연결을 만들려고 하면 “통합 문서가 보호되어 있어서 변경할 수 없습니다.”라는 오류 메시지가 표시되는 문제를 해결합니다. 편집 언어가 일본어, 중국어 또는 한국어인 경우 홈 탭에서 새 글꼴을 선택하려고 하거나 편집할 때 Excel이 중단되는 문제를 해결합니다.
-   Excel을 최소화한 상태에서 통합 문서를 열 때 스크롤 막대가 사라지는 문제를 해결합니다.
...
-   **SVG 아이콘을 도형으로 변환:** 모든 SVG 그림 및 아이콘의 색, 크기 또는 질감을 변경할 수 있도록 Office 도형으로 변환합니다.
-   **Office 365 그룹의 향상된 기능:** 그룹 메시지를 두 번 클릭하여 자체 창에서 열 수 있으므로 전보다 더 쉽게 그룹 대화를 읽고 답할 수 있습니다.
-   **LinkedIn 기능 설정:** 파일 \> 옵션 \> 일반으로 이동하여 Office 응용 프로그램에 표시되는 LinkedIn 기능을 제어합니다. [자세한 정보](https://support.office.com/article/dc81cc70-4d64-4755-9f1c-b9536e34d381)
...
-   **프로필 카드: **데스크톱, 웹 또는 모바일 앱을 사용하는지 여부에 상관없이 인물 및 그룹에 대해 관련성이 가장 높은 정보를 표시합니다.
-   **그룹 일정에 약속 추가:** 이제는 사용자가 부재 중인 경우 전자 메일로 모임을 보내지 않고도 그룹의 모든 구성원에게 알릴 수 있습니다.
-   **클라우드(Cloud) 첨부 파일 다운로드:** OneDrive 첨부 파일을 컴퓨터에 저장하거나 끌어서 놓으면 파일이 다운로드 됩니다.
-   **유용한 사운드로 접근성 향상:**  오디오 신호를 켜면 작업할 때 안내를 받을 수 있습니다. 파일 \>  옵션 \> 접근성에서 확인할 수 있습니다. 추가 기능은 필요하지 않습니다. [자세한 정보](https://support.office.com/article/49fda9be-cce5-4c72-a87f-b11000197f5f)
-   ** 중요 받은 편지함:**  받은 편지함은 중요와 기타, 두 탭으로 분리됩니다. 메시지는 메시지의 콘텐츠와 가장 많이 상호 작용 하는 사람을 기준으로 정렬됩니다. [ 자세한 정보](https://support.office.com/article/f445ad7f-02f4-4294-a82e-71d8964e3978)
-   **가장 자주 사용하는 그룹을 빠르게 접근:** 이제 폴더 창의 그룹 아래에 있는 목록 상단에는 가장 많이 상호 작용하는 그룹이 표시됩니다.

### <a name="outlook-security-updates"></a>Outlook: 보안 업데이트
-   [CVE-2017-11939](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2017-11939): Microsoft Office 정보 공개 취약성
...
-   일부 사용자가 해당 테넌트 관리자에 의해 사용되도록 설정된 지원 기능을 받지 못하는 문제를 해결합니다.
...
-   **디지털 펜슬:** 새로운 연필 텍스처로 아이디어를 메모하거나 스케치하세요. 지원되는 디지털 펜을 기울여서 음영을 표현하세요.
-   **LinkedIn 기능 설정:** 파일 \> 옵션 \> 일반으로 이동하여 Office 응용 프로그램에 표시되는 LinkedIn 기능을 제어합니다. [자세한 정보](https://support.office.com/article/dc81cc70-4d64-4755-9f1c-b9536e34d381)
-   **디지털 펜으로 슬라이드 쇼 실행:** Surface 펜 또는 Bluetooth 단추가 있는 다른 펜을 사용하여 슬라이드를 넘깁니다. Windows 10 Fall Creators Update가 필요합니다. [자세한 정보](https://support.office.com/article/e36da834-7d34-4b71-aafd-071727549f7a)
-   **3D 모델:** 3D를 사용하여 프레젠테이션의 시각적 효과 및 창의적 효과를 향상시킬 수 있습니다. 슬라이드 사이에 씨네마틱 애니메이션을 만드는 모핑 같은 전환을 통해 프레젠테이션에서 3D 모델을 구현할 수 있습니다. [자세한 정보](https://support.office.com/article/ec5feb79-b0af-47f6-a885-151fcc88ac0a)
-   **새 잉크 효과:** 금속 펜과 무지개, 은하수, 용암, 바다, 금색, 은색 등의 잉크 효과를 사용하여 아이디어를 세련되게 표현할 수 있습니다.
-   **파일 공유 UI:** 비즈니스용 OneDrive 또는 SharePoint 파일의 경우, 리본의 오른쪽 상단 모서리에 있는 공유 단추를 클릭하거나 파일 \> 공유로 이동하면 간단하게 개선된 공유 대화 상자가 나타납니다. UI는 사용자가 새 파일 또는 로컬에 저장된 파일을 쉽게 OneDrive에 업로드하여 공동 작업을 시작할 수 있게 합니다.
-   **위험한 확장명 차단:** 위험을 초래할 것으로 간주되며, OLE 패키지 개체로 포함되어 있는 확장명은 기본적으로 활성화되지 않도록 차단됩니다. 예로 .exe, .vbs 및 .js가 있습니다. [자세한 정보](https://support.office.com/article/packager-activation-in-office-365-desktop-applications-52808039-4a7c-4550-be3a-869dd338d834)
-   **수정 내용 강조 표시:** 다른 사용자가 수정한 슬라이드가 강조 표시됩니다.
-   **부재 중 변경 내용:** PowerPoint에는 마지막 방문 이후에 공유한 프레젠테이션을 다른 사용자가 편집한 내용이 표시됩니다.
-   **향상된 디자이너 기능:** 이제 디자이너가 글머리 기호 목록의 타임라인에 대한 디자인 아이디어를 추천합니다.
-   **유용한 사운드로 접근성 향상:** 오디오 신호를 켜면 작업할 때 안내를 받을 수 있습니다. 파일 \> 옵션 \> 접근성에서 확인할 수 있습니다. 추가 기능은 필요하지 않습니다. [자세한 정보](https://support.office.com/article/49fda9be-cce5-4c72-a87f-b11000197f5f)
-   **계정별 파일 위치:** 파일을 열거나 저장할 때 위치 목록이 위치에 연결된 계정을 기준으로 구성됩니다.
-   **펜 사용자 지정:** 잉크 입력을 위해 펜 및 형광펜의 개인 설정을 선택합니다. 사용자 지정 설정을 모든 Windows PC에서 사용할 수 있습니다.
-   **향상된 디자이너 기능:** 이제 디자이너가 슬라이드에 추가된 차트에 대해 디자인 아이디어를 추천합니다.
-   **빠른 시작:** 사용자가 선택한 주제에 대해 연구를 시작하도록 도움이 될 개요를 자동으로 작성합니다. [자세한 정보](https://support.office.com/article/4784f273-0b2c-456c-9c89-24e5b977c224)
...
### <a name="powerpoint-security-updates"></a>PowerPoint: 보안 업데이트
-   [CVE-2017-11934](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2017-11934): Microsoft PowerPoint 정보 공개 취약성
...
-   제한된 보기를 끝낼 때 OneDrive에 저장된 파일을 열면 PowerPoint가 중단되는 문제를 해결합니다. 문서 속성 및 개인 정보를 제거한 후에 SharePoint로 저장하지 못하는 문제를 해결합니다.
-   Flash Player 기반 YouTube 포함 코드를 참조할 경우 동영상 실행을 위해 새 창이 열리는 문제를 해결합니다. 이제 이전 포함 코드는 HTML5 기반 YouTube 동영상을 참조하도록 업그레이드 되므로 YouTube 동영상은 올바른 위치에서 재생됩니다.
...
-   **플래너에서 작업 관리:** 플래너에 프로젝트 작업을 연결하고 계획을 세울 수 있습니다. 작업을 하위 작업으로 나누고 팀을 추가하고 작업을 할당하고 작업 보드에서 작업을 관리합니다.

### <a name="project-non-security-updates"></a>Project: 비보안 업데이트
-   작업을 비용 자원으로 분할할 경우 비용 자원이 올바르게 업데이트되지 않고 비용이 손실되는 문제를 해결합니다.
-   타임라인 보기 - 타임라인에 기존 작업 추가 대화 상자에서 첫 번째 요약 작업의 작업만 표시되는 문제를 해결합니다.
...
-   타임라인 보기에서 타임라인에 기존 작업을 추가할 때 첫 번째 요약 작업의 작업만 대화 상자에 표시되는 문제를 해결합니다.
-   한 세션에서 둘 이상의 기준선을 설정하면 MOD\_DATE 값이 동일하게 설정되는 문제를 해결합니다.
...
-   작업이 남았지만 완료 상태로 표시되는 문제를 해결합니다.
-   작업 경로 기능을 사용하면 프로젝트가 중단되는 문제를 해결합니다.
-   날짜 표시줄에 날짜 표시줄 레이블이 표시되지 않는 문제를 해결합니다.
-   시각적 정보가 불완전한 정보를 표시하거나 완전히 표시하지 못하는 문제를 해결합니다.
-   저장에 실패한 파일이 손상되고 Project가 열려 있을 때 중지하는 문제를 해결합니다.
-   시간 표시줄 및 팀 플래너 보기에 작업을 끌 수 없는 문제를 해결합니다.
-   리소스 가용성이 팀 구성에 표시되지 않는 문제를 해결합니다.
-   그래픽 표시기가 올바르게 표시되지 않는 문제를 해결합니다.
-   시간 단위 또는 일 단위로 평준화할 때 Project가 정지되는 문제를 해결합니다.
-   SharePoint 문서 라이브러리에서 마스터/하위 프로젝트 작업을 수행할 때 발생하는 문제를 해결합니다.
-   고정된 기간 작업에 과제를 추가할 때 이름 없는 리소스가 나타나는 문제를 해결합니다.
-   보호되는 작업이 변경되었다는 잘못된 오류 메시지가 생성되는 문제를 해결합니다.
...
-   모바일 전화번호에 걸린 발신 PSTN 통화의 경우 대화 내용의 통화 기록에 수신자 정보가 표시되지 않는 문제를 해결합니다.
-   Outlook의 전자 메일에서 메신저를 시작하면 전자 메일의 제목 줄이 메신저의 제목에 포함되지 않는 문제를 해결합니다.
-   메신저 대화 창을 한쪽으로 끌어오면 대화가 두 번 누적되어 표시되는 문제를 해결합니다.
-   VDIv2 환경에서 VbSS 화면 공유 요청이 RDP 기반 요청으로 표시되는 문제를 해결합니다.
-   통화 전송이 실패한 경우 실패 알림에 없는 수신자가 아닌 발신자가 나열되는 문제를 해결합니다.
-   "Teams 사용 시작" 버튼이 클라이언트 업그레이드 리디렉션 배너 내에 숨겨져 있는 문제를 해결합니다.
-   메신저 창에서의 DPI 조정 문제를 해결합니다.
-   LinkedIn 데이터가 비즈니스용 Skype 대화 상대 카드에 표시되지 않는 문제를 해결합니다.
...
-   전체 화면 공유 후에 사용자가 메시지를 보낼 수 없는 문제를 해결합니다.
-   사용자가 모임 참석을 거부당하면 대기실에 있는 사용자가 알림을 받지 못하는 문제를 해결합니다.
...
-   **웹사이트에 대한 와이어프레임 다이어그램 만들기:** 인터페이스, 탐색 및 작동 방식을 비롯한 웹 사이트의 와이어프레임 다이어그램을 신속하게 만듭니다. [자세한 정보](https://support.office.com/article/2d54dc55-f5c4-49a2-85da-d649eb7fc281)
-   **모바일 응용 프로그램의 와이어프레임 만들기:** 템플릿을 사용하여 모바일 응용 프로그램의 와이어프레임을 만들 수 있습니다. [자세한 정보](https://support.office.com/article/2d54dc55-f5c4-49a2-85da-d649eb7fc281)
...
-   **디지털 펜슬:** 새로운 연필 텍스처를 이용하여 아이디어를 메모하거나 스케치하세요. 지원되는 디지털 펜을 기울여서 쉽게 음영을 표현하세요.
-   **LinkedIn 기능 설정:** 파일 \> 옵션 \> 일반으로 이동하여 Office 응용 프로그램에 표시되는 LinkedIn 기능을 제어합니다. [자세한 정보](https://support.office.com/article/dc81cc70-4d64-4755-9f1c-b9536e34d381)
-   **SharePoint 속성 패널:** 문서 내에서 SharePoint 문서 라이브러리의 열 값을 표시 및 편집합니다. 보기 탭의 리본 단추를 사용하면 패널에 쉽게 접근할 수 있으며 SharePoint 관리자는 문서 라이브러리 설정을 사용하여 속성 패널을 자동으로 열 수 있습니다.
...
-   **파일 공유 UI:** 비즈니스용 OneDrive 또는 SharePoint 파일의 경우, 리본의 오른쪽 상단 모서리에 있는 공유 단추를 클릭하거나 파일 \> 공유로 이동하면 간단하게 개선된 공유 대화 상자가 나타납니다. UI는 사용자가 새 파일 또는 로컬에 저장된 파일을 쉽게 OneDrive에 업로드하여 공동 작업을 시작할 수 있게 합니다.
-   **위험한 확장명 차단:** 높은 위험을 초래할 것으로 보이며, OLE 패키지 개체로 내장된 확장명은 기본적으로 활성화되지 않도록 차단됩니다. 예로 .exe, .vbs 및 .js가 있습니다. [자세한 정보](https://support.office.com/article/packager-activation-in-office-365-desktop-applications-52808039-4a7c-4550-be3a-869dd338d834)
-   **학습 도구를 사용한 편집:** 이제 Word의 웹 레이아웃에서 학습 도구를 사용할 수 있습니다. 편집하는 동안 텍스트 간격을 조정하고 음절을 표시합니다. 모든 뷰에서 문서를 소리내어 읽을 때 각 단어가 강조 표시되는 것을 볼 수 있습니다. [자세한 정보](https://support.office.com/article/a857949f-c91e-4c97-977c-a4efcaf9b3c1)
...
-   SharePoint Online에서 파일을 열면 Word 작업이 중단되는 문제를 해결합니다.
-   소문자 로마 숫자로 된 페이지 번호가 대문자로 잘못 변환되는 문제를 해결합니다.
-   메모리 부족 메시지를 표시하게 만드는 문제를 해결합니다.
-   Windows 7이 실행되는 컴퓨터에서 고객 환경 및 진단 원격 분석에 대한 업데이트가 설치되지 않은 경우 Word가 열리지 않는 문제를 해결합니다.
-   목록의 글머리 기호가 인쇄되지 않는 문제를 해결합니다.
-   비지니스용 OneDrive의 기존 문서를 다른 이름으로 저장 후 취소하거나 기존 변경 내용을 병합하려 할 때 Word가 중단되는 문제를 해결합니다.
-   편지 병합 마법사를 실행할 때, null 값이 포함된 데이터 원본 필드를 필터링하지 못하는 문제를 해결합니다.
-   동기화 백업 파일을 저장할 때 Office에서 디스크를 쓸 수 없지만 파일을 계속 OneDrive로 업로드하는 문제를 해결합니다. 이 수정 사항을 통해 사용자는 이제 오류 메시지를 확인할 수 있으며 업로드가 진행되지 않습니다.
...
### <a name="office-suite-non-security-updates"></a>Office 제품군: 비보안 업데이트
-   System Center 구성 관리자를 사용하여 Office 응용 프로그램을 실행하는 클라이언트에 업데이트를 배포할 때, Office 응용 프로그램이 실행되는 동안 장치를 다시 시작하면 업데이트가 적용되지 않는 문제를 해결합니다.
...
-   사용자가 Office 정품 인증 대화 상자를 사용하여 Office의 정품 인증을 시도하면 Office 앱이 중지하는 문제를 수정합니다.
...
-   .box 파일이 동일한 컴퓨터의 모든 Office 앱 버전에서 공유되므로, .box 파일 형식이 변경될 경우 그 컴퓨터에 설치된 이전 Office 버전의 기능에 영향을 미치는 문제를 해결합니다.
...
*2018년 1월부터 제공된 반기 채널 릴리스입니다. 이 릴리스는 2019년 3월까지 계속 지원되며 보안 업데이트를 받게 됩니다. 그러나 이제 새로운 반기 채널 릴리스 버전 1803 (빌드 9126.2259)을 사용할 수 있습니다. 여기에는 새로운 기능, 보안 업데이트 및 비보안 업데이트가 포함되어 있습니다.*
...
## <a name="version-1705-april-10"></a>CVE-2018-1030: Microsoft Office 원격 코드 실행 취약성
...
-   **더 편리하게 새 항목 편집:** 빠른 키보드 단축키(Ctrl+E)를 사용하여 콤보 상자 또는 목록 상자에서 새 항목을 편집합니다.
...
### <a name="access-non-security-updates"></a>Access: 비보안 업데이트
-   콤보 상자의 텍스트 상자에서 텍스트를 선택하려고 할 때 선택 영역만 표시되지 않고 모든 텍스트가 선택된 것처럼 나타나는 문제를 해결합니다.
-   쿼리에 Microsoft Dynamics와 연결된 테이블의 기본 키를 사용하는 조인이 있으면 해당 쿼리가 실행되지 않는 문제를 해결합니다.
-   Microsoft Dynamics 테이블에서 통화 값에 소수 자릿수가 표시되지 않는 문제를 해결합니다.

### <a name="excel-feature-updates"></a>Excel: 기능 업데이트
-   **“예제에서 열 추가” 기능 향상:** 자세한 날짜/시간, 수학 및 인덱스 열 변환을 지원합니다.
-   **성능 개선:** Excel에서 여러 개의 시트가 있는 복잡한 통합 문서를 빠르게 열어 큰 범위의 수식을 확인하고, 여러 개의 행을 필터링하거나 신속하게 복사하여 붙여넣을 수 있습니다.
-   **온라인 사진 삽입:** 선택한 이미지 및 속성 정보에 대한 새 방문 페이지에 이미지가 자동 삽입됩니다.
-   **Azure Data Lake Store 커넥터:** 이제 사용자가 Azure Data Lake Store에서 데이터를 가져올 수 있습니다.
-   **"예제에서 열 추가" 기능 향상:** 제안, 더 많은 날짜/시간 작업 및 추가 변환을 지원합니다.
...
-   **데이터 가져오기 기능 향상:** 다양한 소스에서 데이터를 쉽게 가져오고 형성할 수 있습니다. 쿼리 및 연결 왼쪽 창에서 통합 문서 쿼리 및 연결을 관리하고 ODC 파일을 통해 다른 사람과 쿼리를 공유합니다. [추가 정보](https://support.office.com/article/ad78befd-eb1c-4ea7-a55d-79d1d67cf9b3)
...
-   프로그래밍 방식으로 피벗 테이블을 생성한 후 프로그래밍 방식으로 새로 고칠 경우 Excel이 중단되는 문제를 해결합니다.
-   매크로가 있는 Office 2007 또는 이전 버전의 통합 문서(.xls 또는 .xla)를 열면 사용자에게 "치명적 오류 발생" 오류 메시지가 잘못 표시되는 문제를 수정합니다.
-   명령줄에서 통합 문서를 열면 셀에서 서식 있는 텍스트가 손실될 수 있는 문제를 수정합니다.
-   파일 이름에 대괄호가 포함되어 있는 경우 사용자가 제한된 보기에서 통합 문서를 닫을 수 없는 문제를 해결합니다.
-   사용자가 기존 통합 문서에서 개체를 삽입하려고 할 때 탐색을 클릭하면 Excel이 충돌하는 문제를 해결합니다.
-   “텍스트에 맞게 도형 크기 조정”(도형 서식 창에서 텍스트 옵션/텍스트 상자 부분)을 선택할 경우 도형이 변경되지 않는 문제를 해결합니다.
-   통합 문서를 두 번 클릭하여 열 때 셀 텍스트 글꼴 및 형식이 로드되지 않거나 단일 템플릿에 대해 두 개의 동일한 통합 문서가 열리는 문제를 해결합니다.
-   Excel이 시작될 때 만들어진 첫 번째 통합 문서가 새 통합 문서를 열거나 만들어도 닫히지 않는 문제를 해결합니다.
-   끌거나 끌어서 채울 시, 도구 설명의 위치가 일치하지 않는 문제를 해결합니다.
-   통합 문서를 파일 \> 다른 이름으로 저장으로 저장할 때, 파일 이름에 마침표가 포함되면 파일이 저장 대화상자에 빈 상태로 혹은 잘려서 나타나는 문제를 수정합니다.
-   동기화 백업 파일을 저장할 때 Office에서 디스크에 쓸 수 없지만 파일을 계속 OneDrive로 업로드하는 문제를 해결합니다. 이 수정 사항을 통해 사용자는 이제 오류 메시지를 확인할 수 있으며 업로드가 진행되지 않습니다.
...
-   페이지 레이아웃 보기에서 머리글이나 바닥글을 추가한 후에 셀의 무늬 스타일이 올바르게 렌더링되지 않는 문제를 해결합니다.
-   피벗 테이블의 복사본을 다른 통합 문서에 붙이면 충돌이 일어나는 문제를 해결합니다.
-   바꾸기 명령을 선택해서 찾기 및 바꾸기 대화 상자를 열었을 때 대화 상자의 포커스가 찾기 탭이 아니라 바꾸기 탭에 있는 문제를 해결합니다.
-   SharePoint Server 2016 이전의 SharePoint Server에서 연 통합 문서의 작업 창을 열면 Excel이 충돌하는 문제를 해결합니다.
-   하나 이상의 XLL 추가 기능을 사용하는 경우 Excel이 빈 창을 열어 표시하는 문제를 해결합니다.
-   이미 닫힌 통합 문서에서 양식 단추를 사용하면 Excel이 충돌하는 문제를 해결합니다.
-   SheetBeforeRightClick 이벤트를 사용할 때 병합된 셀을 교차하도록 열을 삽입해도 병합된 셀이 확장되지 않는 문제를 해결합니다.
-   피벗 테이블을 확장 또는 축소할 때 피벗 테이블 머리글이 화면 밖으로 이동할 경우 Excel이 일시적으로 응답하지 않는 문제를 해결합니다.
-   탭으로 구분된 텍스트를 Word에서 복사하여 붙여넣으면 탭이 무시되어 텍스트가 열로 구문 분석되지 않는 문제를 해결합니다.
-   웹 페이지 게시 대화 상자를 열 때 Excel이 충돌하는 문제를 해결합니다.
-   SQL Server Analysis Services 서버의 데이터를 사용하는 경우 데이터 새로 고침이 성공하지 못하거나 Excel이 중단되고 Excel의 로캘과 SQL Server Analysis Services 서버의 로캘이 다른 문제를 해결합니다.
-   OneDrive 클라이언트와 동기화되는 문서에 변경 내용을 저장하려고 할 때 오류가 나타나는 문제를 해결합니다.
-   필터 영역에 필드가 있는 피벗 테이블이 있지만 다른 어느 곳에도 필드가 없을 때, 워크시트 아무 곳에서도 변경할 수 없는 문제를 해결합니다.

### <a name="outlook-feature-updates"></a>Outlook: 기능 업데이트
-   **접근성 개선:** 화면 읽기 프로그램을 사용하는 경우 전자 메일에서 텍스트, 표, 목록 및 이미지를 더욱 쉽게 읽고 편집할 수 있습니다.
-   **새 계정 구성:** 필요한 수동 단계가 줄어든 새 마법사로 새 계정을 설정합니다.
-   **링크 첨부 대화:** 리본에서 파일 첨부를 사용하여 링크를 첨부할 때, 링크로 추가할지 첨부 파일로 추가할 지를 선택할 수 있습니다. 이 대화를 매번 표시하지 않으려면 파일 \> 옵션 \> 일반으로 이동한 다음, “첨부 파일 옵션”에서 링크를 첨부할 방법을 지정하세요.
...
-   **Office 365의 그룹에 대한 게스트 액세스:** 그룹 대화, 파일, 일정 초대 및 그룹 전자 필기장에 대한 액세스 권한을 부여하여 조직 외부의 사용자와 공동으로 작업합니다. [자세한 정보](https://support.office.com/article/bfc7a840-868f-4fd6-a390-f347bf51aff6)
-   **실행 가능한 메시지:** 개발자는 사용자가 외부 웹 사이트나 별도 앱으로 전환하지 않고도 Outlook에서 간편하고 빠르게 조치를 취할 수 있도록 메시지를 만들 수 있습니다. [자세한 정보](https://dev.office.com/blogs/create-more-engaging-conversations-with-new-actionable-messages-updates-announced-at-microsoft-build)
...
-   [CVE-2017-8572](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2017-8572): Microsoft Office Outlook 정보 공개 취약성
...
### <a name="outlook-non-security-updates"></a>Outlook: 비보안 업데이트
-   사용자가 메시지를 삭제할 때 메시지 목록의 포커스가 예기치 않게 이동하는 문제를 해결합니다.
-   사용자가 첨부 파일로 상호 작용할 때 인증 프롬프트가 표시되는 문제를 해결합니다.
-   진한 회색 테마를 사용하면 정책 팁의 "자세한 내용" 링크가 보이지 않는 문제를 해결합니다.
-   사용자가 새 계정을 설정하다가 계정 설정을 완료하지 않은 채로 창을 닫으면 Outlook이 충돌하는 문제를 해결합니다.
-   그룹이 공유하는 받은 편지함에서 읽은 상태와 읽지 않은 상태가 메시지의 옵션으로 표시되는 문제를 해결합니다.
-   Outlook에서 IMAP 계정을 구성할 수 없는 문제를 해결합니다.
-   Outlook을 열 때 일시적으로 작동이 중지하는 문제를 해결합니다.

### <a name="powerpoint-feature-updates"></a>PowerPoint: 기능 업데이트
-   **온라인 사진 삽입:** 선택한 이미지 및 속성 정보에 대한 새 방문 페이지에 이미지가 자동 삽입됩니다.
-   **동영상의 선택 자막:** 동영상에 더 쉽게 액세스할 수 있도록 선택 자막을 추가합니다.[자세한 정보](https://support.office.com/article/a16745e1-b3da-4428-b2a7-ff0c8b758d0b)
-   **기록 내레이션** 프레젠테이션을 기록할 때 내레이션하는 자신의 목소리를 포함합니다. 기록에는 애니메이션, 잉크, 오디오 및 비디오가 포함될 수 있습니다.
-   **공유 파일 활동:** 파일의 오른쪽 위 구석에 있는 활동 단추를 선택하면 비즈니스용 OneDrive 또는 SharePoint에서 공유되는 파일을 공유하거나, 편집하거나, 이름을 바꾸거나, 복원하는 경우를 알 수 있습니다.
-   **대체 텍스트 만들기:** 클라우드 기반 서비스는 프레젠테이션의 그림에 대한 대체 텍스트를 자동으로 생성합니다.
-   **안전한 링크:** 사용자가 링크를 클릭하면 Office 365 ATP(Advanced Threat Protection)에서 해당 링크의 악성 여부를 검사합니다. 링크가 악성으로 간주되면 사용자는 기존 대상 URL이 아닌 경고 페이지로 리디렉션됩니다. [추가 정보](https://support.office.com/article/dd6a1fef-ec4a-4cf4-a25a-bb591c5811e3)
-   **향상된 디자이너 기능:** 작업 기반 목록에 대한 전문적인 디자인 아이디어를 권장합니다.
-   **공유 파일의 변경 내용:** 공유 프레젠테이션을 변경한 사람을 확인하고 이전 버전을 복원합니다. [자세한 정보](https://support.office.com/article/5c1e076f-a9c9-41b8-8ace-f77b9642e2c2)
...
### <a name="powerpoint-non-security-updates"></a>PowerPoint: 비보안 업데이트
-   동기화 백업 파일을 저장할 때 Office가 디스크에 쓸 수 없지만 파일을 계속 OneDrive로 업로드하는 문제를 해결합니다. 이 수정 사항을 통해 사용자는 이제 오류 메시지를 확인할 수 있으며 업로드가 진행되지 않습니다.
-   표에서 실행 취소한 후에 텍스트를 편집하고 서식을 지정할 경우 PowerPoint가 충돌하는 문제를 해결합니다.
-   Flash Player 기반 YouTube 포함 코드를 참조할 경우 비디오 실행을 위해 새 창이 열리는 문제를 해결합니다. 이제 이전 포함 코드가 HTML5 기반 YouTube 비디오를 참조하도록 업그레이드되므로 YouTube 비디오가 올바르게 고정되어 재생됩니다.
-   SharePoint Server 2016 이전의 SharePoint Server에서 프레젠테이션을 열면 PowerPoint가 충돌하는 문제를 해결합니다.
-   글꼴에 연결된 최종 사용자 정의 문자(EUDC)가 표시되지 않는 문제를 해결합니다.

### <a name="project-non-security-updates"></a>Project: 비보안 업데이트
-   프로젝트 수준 사용자 지정 필드 데이터가 저장 시 손실될 수 있는 문제를 해결합니다.
-   저장에 실패하면 파일이 손상되고 프로젝트가 열려 있을 때 중지되는 문제를 해결합니다.
-   프로젝트 계획을 열면 중지될 수 있는 문제를 해결합니다.
-   Project Online에서 특정 파일을 열 때 프로젝트가 충돌하는 문제를 해결합니다.
...
-   하나의 기준선에서 다른 기준선으로 저장할 때 예산 리소스에 대한 시간대별 데이터가 복사되지 않는 문제를 해결합니다.
-   상태 필드가 때때로 요약 작업을 정확하게 계산하지 않는 문제를 해결합니다.
-   로컬 리소스를 대체하고 보호된 작업을 사용할 때 실제 작업이 Enterprise 자원으로 잘못 전송되는 문제를 해결합니다.
-   테이블 첫 번째 열이 작업 이름이고 잠겨 있는 경우 작업을 클릭하면 Project가 중지하는 문제를 해결합니다.
-   작업 배정 현황 보기를 통해 동일한 작업에 동일한 리소스를 여러 번 지정할 수 있는 문제를 해결합니다.
-   XML 파일을 열 때 번호 사용자 정의 필드의 값이 손실될 수 있는 문제를 해결합니다.
-   최상위 수준의 작업 들여쓰기가 프로젝트에서 SharePoint 작업 목록으로 올바르게 동기화되지 않는 문제를 해결합니다.
-   Excel 통합 문서에서 작업, 리소스 또는 할당 정보를 가져오는 경우 작업 필드의 값이 무시될 수 있는 문제를 해결합니다.
-   프로젝트를 XML 파일 형식으로 저장하면 시간대별 기준선 값이 초기값과 일치하지 않는 문제를 해결합니다.
...
-   [CVE-2017-8676](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2017-8695):  Windows GDI+ 정보 공개 취약성
...
-   IM 대화 탭을 클릭하면 영구 채팅방의 읽지 않은 메시지가 읽음으로 표시되는 문제를 해결합니다.
-   들어오는 IM 알림이 몇 초 동안 지연되는 문제를 해결합니다.
-   Exchange와의 동기화를 사용할 수 없는 경우 AD 연락처가 연락처 이름이 아닌 전화번호로 표시되는 문제를 해결합니다.
-   페더레이션을 사용할 수 없고 모임 이끌이가 명시적으로 익명 참가를 차단하지 않은 경우 익명 참가 사용자가 참가하지 못하는 문제를 해결합니다.
-   제한을 초과하는 모임에 대해 모임 이끌이에게 초대 대상자의 수가 잘못 표시되는 문제를 해결합니다.
-   인바운드 PSTN 통화에서 알림에 전화번호가 표시되지 않는 문제를 해결합니다.
-   연락처 목록 그룹 이름을 바꾸는 도중 Delete 키를 사용하면 전체 그룹이 삭제되는 문제를 해결합니다.
-   공유가 중지되기 전에 IM 대화의 공유 알림이 해제되는 문제를 해결합니다.
...
-   통화 드롭다운 메뉴에서 연락처에 중복된 번호가 표시되는 문제를 해결합니다.
-   비즈니스용 Skype와 비즈니스용 Skype Basic 간을 이동하는 사용자의 대리자가 삭제되는 문제를 해결합니다.
-   오프라인으로 표시 사용 및 사용자 정의 상태 URL 클라이언트 정책을 사용할 때 오프라인으로 표시가 나타나지 않는 문제를 해결합니다.
-   모임 참가 단추를 확장하여 일부 지역화된 언어가 잘리는 문제를 해결합니다.
...
-   새 DWORD 레지스트리 키를 추가하여 사용자가 LyncAutoD를 수행하는 외부 네트워크의 클라이언트에 로그인할 때 클라이언트가 OAuthUsed 레지스트리 키를 False로 재설정하는 문제를 해결합니다. 이 문제를 해결하려면 HKEY\_CURRENT\_USER\\Software\\Microsoft\\Office\\16.0\\Lync\\\<SipID\>에서 EnableRestoreOAuthUsedKeyWhenUsingCachedWebTicket의 값을 1로 설정합니다.

### <a name="visio-feature-updates"></a>Visio: 기능 업데이트
-   **Excel 데이터에서 다이어그램 만들기:** 새 데이터 시각화 도우미 템플릿을 사용하여 Excel 데이터에서 기본 순서도 또는 부서간 업무 흐름도를 자동으로 만듭니다. [자세한 정보](https://support.office.com/article/17211b46-d144-4ca2-9ea7-b0f48f0ae0a6)
-   **안전한 링크:** 사용자가 링크를 클릭하면 Office 365 ATP(Advanced Threat Protection)에서 해당 링크의 악성 여부를 검사합니다. 링크가 악성으로 간주되면 사용자는 기존 대상 URL이 아닌 경고 페이지로 리디렉션됩니다. [추가 정보](https://support.office.com/article/dd6a1fef-ec4a-4cf4-a25a-bb591c5811e3)

### <a name="visio-non-security-updates"></a>Visio: 비보안 업데이트
-   파일 아이콘이나 파일 이름을 두 번 클릭하여 Visio 파일을 열 때 COM 추가 기능에서 이벤트가 열린 문서를 받지 못하는 문제를 해결합니다.
...
-   **공유 파일 활동:** 파일의 오른쪽 위 구석에 있는 활동 단추를 선택하면 비즈니스용 OneDrive 또는 SharePoint에서 공유되는 파일을 공유하거나, 편집하거나, 이름을 바꾸거나, 복원하는 경우를 알 수 있습니다.
-   **안전한 링크:** 사용자가 링크를 클릭하면 Office 365 ATP(Advanced Threat Protection)에서 해당 링크의 악성 여부를 검사합니다. 링크가 악성으로 간주되면 사용자는 기존 대상 URL이 아닌 경고 페이지로 리디렉션됩니다. [추가 정보](https://support.office.com/article/dd6a1fef-ec4a-4cf4-a25a-bb591c5811e3)
-   **공유 파일의 변경 내용:** 공유 문서를 변경한 사람을 확인하고 이전 버전을 복원합니다. [자세한 정보](https://support.office.com/article/5c1e076f-a9c9-41b8-8ace-f77b9642e2c2)
...
-   SharePoint Server 2016 이전의 SharePoint Server에서 연 문서의 작업 창을 열면 Word가 충돌하는 문제를 해결합니다.
-   Grammarly 추가 기능을 로드하는 도중 Word가 갑자기 닫히는 문제를 해결합니다.
-   클라우드 기반 파일을 복구하는 도중 특정 조건에서 Word가 중지하는 문제를 해결합니다.
-   그리기 캔버스 내의 도형을 회전할 수 없는 문제를 해결합니다.
-   한국어를 입력할 때 자음과 모음이 정확하지 않게 구분되는 문제를 해결합니다.
...
-   Office 365 ProPlus가 현재 설치되어 있더라도 Office CSP(구성 서비스 공급자)의 CurrentStatus 노드가 빈 문자열을 반환하는 문제를 해결합니다.
-   .box 파일이 동일한 컴퓨터의 모든 Office 앱 버전에서 공유되므로, .box 파일 형식이 변경될 경우 그 컴퓨터에 설치된 이전 Office 버전의 기능에 영향을 미치는 문제를 해결합니다.
-   공유 컴퓨터 정품 인증을 사용하는 특정 상황에서 앱 실행 중에 오류가 발생했다는 오류 메시지가 나타나 앱이 제대로 작동하지 못하고 사용자에게 복구를 실행할지 묻는 문제를 해결합니다.
-   온라인 복구 진행 상황이 사용자에게 표시되지 않는 문제를 해결합니다.
-   파일 탐색기에 Office 파일 속성이 표시되지 않는 문제를 해결합니다.
-   두 번째 문서가 열려 있으면 리본에서 Office 추가 기능 단추가 사라지는 문제를 해결합니다.
-   이름에 더블바이트 문자가 있는 일부 VBA 모듈을 열 수 없는 문제를 해결합니다.
-   새 소식 대화 상자가 나타나지 않는 문제를 해결합니다.
-   그리기 탭을 클릭하면 일부 사용자의 응용 프로그램이 중단되는 문제를 해결합니다.
-   도구 설명이 있는 일반 컨트롤을 가리킬 때 응용프로그램이 중단되는 문제를 해결합니다.
-   일반 컨트롤을 사용하는 경우 라이선스 오류 메시지가 나타나는 문제를 해결합니다.
-   일부 프로그램 파일이 서명되는 방식으로 인해 바이러스 백신 프로그램이 이러한 파일에 플래그를 표시하는 문제와 WIP(Windows Information Protection)의 데이터 보호 및 액세스에 발생하는 문제를 해결합니다.
-   Office 64비트 버전에서 작업하는 사용자가 mscomctl.ocx 컨트롤이 포함된 매크로 파일을 열 수 있도록 하는 지원을 추가합니다.
-   mscomctl.ocx에서 사용되는 컨트롤의 가용성을 개선합니다.
-   리본 또는 빠른 실행 도구 모음 사용자 지정 대화 상자에서 명령이 누락되는 문제를 해결합니다.
